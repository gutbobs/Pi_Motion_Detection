...
def main(variables_filename):
  ...
  motion_event_wait_timeout = global_variables["motion_event_wait_timeout"] # seconds

  filepath = global_variables["file_path"]
  logger_filename = os.path.join(filepath,global_variables["log_file"])
  ...
  video_width = global_variables["video_width"] 
  video_height = global_variables["video_height"] 

  video_framerate = global_variables["video_framerate"] # setup the camera video framerate
  ...
  perform_snapshot_capture = global_variables["perform_snapshot_capture"] 
  snapshot_capture_filename = global_variables["snapshot_capture_filename"] 
  ...
  motion_width  = global_variables["motion_width"] 
  motion_height = global_variables["motion_height"] 
  ...
  motion_cmd = global_variables["motion_cmd"] 
